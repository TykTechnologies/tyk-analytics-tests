...
class Apis_page extends Page {
  ...
  get OAS_OIDC_ADD_CLIENT_BUTTON() {return new Button_object('span*=Add Client');}
  get OAS_OIDC_MAP_CLIENT_TO_POLICY_FIRST_TABLE() {return new OasMapToPolicyTable_object('//input[@name="x-tyk-api-gateway.server.authentication.oidc.providers[0].issuer"]//following::ul[1]');}
