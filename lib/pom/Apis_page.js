...
class Apis_page extends Page {
  ...
  //GRAPHQL APIS PAGES
  get GRAPHQL_SCHEMA_TAB_BUTTON() {return new Button_object('//button[text()="Schema"]')};
  get GRAPHQL_ENABLE_PLAYGROUND_TOGGLE() {return new Toggle_object('//span[text()="Enable Playground"]');}
  get API_TYPE_GRAPHQL_BUTTON() {return $('//label[text()="GraphQL"]')}
  get API_TYPE_UDG_BUTTON() {return $('//label[text()="UDG"]')}
  ...
  get api_updated_expected_mesage() {return 'The Api has been successfully updated';}
