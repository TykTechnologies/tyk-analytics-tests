...
class Apis_page extends Page {
  ...
  //OAS API PAGE
  get OAS_API_NAME_INPUT() {return $('//input[@name="info.title"]');}
  get OAS_API_REST_RADIO() {return $('//label[text()="REST"]');}
  get OAS_LISTEN_PATH_INPUT() {return $('//input[@name="x-tyk-config.proxy.listen-path.url"]');}
  get OAS_AUTHENTICATION_DROPDOWN() {return $('//span[@title="Select authentication type"]');}
  get OAS_TARGET_URL_INPUT() {return $('//input[@name="x-tyk-config.proxy.target-url"]');}
  get OAS_NEXT_BUTTON() {return $('//span[text()="Next"]');}
  get OAS_SEARCH_ICON() {return $('//i[contains(@class,"fa-search")]');}
  get OAS_SEARCH_BAR() {return $('//input[@name="search"]');}
  get OAS_SEARCH_BAR_CLOSE_ICON() {return $('//button[contains(@class, "search-input__close-btn")]');}
  get OAS_SEARCH_BAR_CLEAR_ICON() {return $('//input[@name="search"]//following::button[1]');}
