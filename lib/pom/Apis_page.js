...
class Apis_page extends Page {
  ...
  get API_NAME_INPUT() {return new Input_object('//input[@name="api_definition.name"]');}
  ...
  get API_TYPE_GRAPHQL_BUTTON() {return new Button_object('//label[text()="GraphQL"]');}
  get API_TYPE_PROXY_ONLY_BUTTON() {return new Button_object('//label[text()="Proxy to existing GraphQL service"]')}
  get API_TYPE_UDG_BUTTON() {return new Button_object('span*=Universal Data Graph');}
