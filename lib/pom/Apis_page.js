...
class Apis_page extends Page {
  ...
  //CUSTOM AUTH PLUGIN
  get OAS_CUSTOM_AUTH_USEHEADER_BOX() { return $('//input[@name="x-tyk-api-gateway.server.authentication.customPlugin.header.enabled"]'); }
  ...
  get OAS_CUSTOM_ALLOW_QUERY_PARAM_BOX() { return $('//input[@name="x-tyk-api-gateway.server.authentication.customPlugin.query.enabled"]'); }
  get OAS_CUSTOM_USE_COOKIE_BOX() { return $('//input[@name="x-tyk-api-gateway.server.authentication.customPlugin.cookie.enabled"]'); }
  get OAS_CUSTOM_QUERY_PARAM_INPUT() { return new Input_object('//input[@name="x-tyk-api-gateway.server.authentication.customPlugin.query.name"]'); }
  ...
  get FEDERATION_ADD_SUBGRAPH_DROPDOWN() { return new DropDown_object('//div[@class="tyk-modal__body"]//div[@class="tyk-form-control"]'); }
  ...
  //get UDG_IMPORT_SCHEMA_FILE_BUTTON() {return new Button_object('//div[@class="tyk-file-input__wrapper"]//input[@label="Import File"]');}
  ...
  verifyFileUploadInSchemaEditor(verificationArray) {
  ...
  uploadSchemaFile(schemaFileRelativePath) {
    ...
    apis_page.UDG_IMPORT_SCHEMA_FILE_FIELD.setValue(remoteFilePath);
  };
