...
get ADD_NEW_API_BUTTON() {return new Button_object('a*=Add new API');}
get PUBLIC_API_NAME_INPUT() {return new Input_object('input[name="name"]');}
get SELECT_POLICY_DROPDOWN() {return new DropDown_object('.tyk-combobox__placeholder');}
get DESCRIBE_THIS_API_INPUT() {return new Input_object('[placeholder="A really cool API that provides badger widgets"]');}
