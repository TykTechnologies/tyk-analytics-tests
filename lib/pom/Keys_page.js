...
get key_updated_expected_mesage() {return 'Key has been successfully updated';}
get key_deleted_expected_mesage() {return 'Key has been successfully deleted';}
get key_created_expected_message() {return 'Key has been successfully created';}

isKeyUpdatedPopUpDisplayed() {return this.isSuccessPopupDisplayedWithText(this.key_updated_expected_mesage);}
isKeyDeletedPopUpDisplayed() {return this.isSuccessPopupDisplayedWithText(this.key_deleted_expected_mesage);}
isKeyCreatedPopUpDisplayed() {return this.isSuccessPopupDisplayedWithText(this.key_created_expected_mesage);}
