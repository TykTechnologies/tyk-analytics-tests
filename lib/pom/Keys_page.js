...
get KEY_HASH_VALUE() {return $('.tyk-header--edit-mode h4:nth-child(2) .tyk-button');}
get KEY_ID_VALUE() {return $('.tyk-header--edit-mode h4:nth-child(1) .tyk-button');}
...
get CREATE_NEW_PASSWORD_CHECKBOX() {return new Checkbox_object('.tyk-checkbox input');}
...
get COPY_KEY_HASH_BUTTON() {return new Button_object('.tyk-message--success button:nth-of-type(2)');};
get KEY_ID_BUTTON() {return new Button_object('.tyk-message--success button:nth-of-type(1)');};
