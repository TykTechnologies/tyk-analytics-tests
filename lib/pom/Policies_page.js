...
class Policies_page extends Page {
  ...
  get API_SECTION_HEADER() {return new Button_object('h4=Add API Access Rights');}
  ...
  get POLICY_STATE_DROPDOWN() {return new DropDown_object('.tyk-combobox2__current-values .policy-state');}
