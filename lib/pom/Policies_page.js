...
class Policies_page extends Page {
  ...
  get ACCESS_RIGHTS_DROPDOWN() {return new DropDown_object('//label[text()="Access Rights"]//following::span[1]');}
  get AUTH_TYPES_DROPDOWN() {return new DropDown_object('//label[text()="Authentication Type"]//following::span[1]');}
