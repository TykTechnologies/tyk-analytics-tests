...
class Policies_page extends Page {
  ...
  get TAG_INPUT() {return new Input_object('input[name="inputTag"]');}
  get ADD_TAG_BUTTON() {return new Button_object('//input[@name="inputTag"]//following::span[text()="ADD"][1]');}
  get EDIT_TAG_BUTTON() {return new Button_object('//i[contains(@class, "fa-edit")]');}
  get DELETE_TAG_BUTTON() {return new Button_object('//i[contains(@class, "fa-trash")]');}
