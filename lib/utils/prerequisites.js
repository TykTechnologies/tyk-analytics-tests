...
export const setUpEnv = () => {
    ...
    //CHECKING IF ENV IS UP !! DISABLED FOR release-3-lts !!!
    // const statusResponse = dashboard_admin_request.getStatus(authorizationHeader);
    // expect(statusResponse.status).to.equal(200, "Dashboard is down!");
    //PREPARING ORG
