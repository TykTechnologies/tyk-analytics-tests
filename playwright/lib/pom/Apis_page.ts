...
export class Apis_page extends Template_Page {
  ...
  get API_TABLE() { this.page.locator('.tyk-table'); }
  ...
  get API_TYPE_SUPERGRAPH_BUTTON() { this.page.locator('//input[@name="subType" and @value="supergraph"]'); }

  //LANDING PAGE
  get IMPORT_API_BOX() { this.page.locator('h2*=Import API'); }
  get DESIGN_API_BOX() { return new Button_object('h2*=Design new API', this.page); }

  //OAS SIDE MENU
  get SIDE_MENU_BASE_LINK() { this.page.locator('//span[text()="Info"]'); }
  get SIDE_MENU_MIDDLEWARE_LINK() { this.page.locator('//span[text()="Middleware"]'); }
  get SIDE_MENU_SERVER_LINK() { this.page.locator('//span[text()="Server"]'); }
  get SIDE_MENU_UPSTREAM_LINK() { this.page.locator('//span[text()="Upstream"]'); }
  ...
  get OAS_HIDDEN_MATCH_MSG() { this.page.locator('//p[contains(@class, "hidden-search-results__message")]'); }
  get OAS_SAVE_BUTTON() { return new Button_object('//button[@type="submit"]', this.page); }
  get OAS_AUTHENTICATION_SAVED() { this.page.locator('//label[text()="Authentication"]//following::p[1]'); }
  get OAS_CHOSEN_AUTH_TYPES_SAVED() { this.page.locator('//label[text()="Chosen Authentication Types"]//following::div[2]'); }
  get OAS_BASE_IDENTITY_PROVIDER_SAVED() { this.page.locator('//label[text()="Base Identity Provider"]//following::div[2]'); }
  get OAS_STRIP_AUTHORIZATION_DATA_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.stripAuthorizationData"]'); }
  ...
  get OAS_OPTIONS_PASS_THROUGH_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.middleware.global.cors.optionsPassthrough"]'); }
  get OAS_ALLOW_CREDENTIALS_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.middleware.global.cors.allowCredentials"]'); }
  get OAS_DEBUG_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.middleware.global.cors.debug"]'); }
  ...
  get OAS_ALLOW_ALL_ORIGINS_BOX() { this.page.locator('//label[contains(text(),"Allow All Origins")]//input'); }
  get OAS_ALLOW_ALL_HEADERS_BOX() { this.page.locator('//label[contains(text(),"Allow All Headers")]//input'); }
  get OAS_MAX_AGE_SAVED() { this.page.locator('//span[text()="Max Age (seconds)"]//following::div[2]'); }
  get OAS_ALLOWED_METHODS_SAVED() { this.page.locator('//span[text()="Allowed Methods"]//following::div[2]'); }
  get OAS_ALLOWED_ORIGINS_SAVED() { this.page.locator('//span[text()="Allowed Origins"]//following::div[2]'); }
  get OAS_ALLOWED_HEADERS_SAVED() { this.page.locator('//span[text()="Allowed Headers"]//following::div[2]'); }
  get OAS_EXPOSED_HEADERS_SAVED() { this.page.locator('//span[text()="Exposed Headers"]//following::div[2]'); }
  ...
  get OAS_UPSTREAM_CACHE_CONTROL_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.middleware.global.cache.enableUpstreamCacheControl"]'); }
  ...
  get OAS_CACHE_ALL_SAVE_REQUEST_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.middleware.global.cache.cacheAllSafeRequests"]'); }
  ...
  get OAS_CACHE_TIMEOUT_SAVED() { this.page.locator('//span[text()="Cache Timeout"]//following::div[2]'); }
  get OAS_CACHE_RESPONSE_CODES_SAVED() { this.page.locator('//span[text()="Cache Response Codes"]//following::div[2]'); }
  get OAS_CACHE_BY_HEADERS_SAVED() { this.page.locator('//span[text()="Cache by Headers"]//following::div[2]'); }
  get OAS_CACHE_CONTROL_TTL_HEADER_SAVED() { this.page.locator('//span[text()="Cache Control TTL Header"]//following::div[2]'); }
  ...
  get OAS_SD_ENABLE_CACHE_TIMEOUT_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.upstream.serviceDiscovery.enableCacheTimeout"]'); }
  ...
  get OAS_SD_ENDPOINT_RETURNS_LIST_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.upstream.serviceDiscovery.endpointReturnsList"]'); }
  get OAS_SD_ENDPOINT_PROVIDES_TARGET_LIST_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.upstream.serviceDiscovery.useTargetList"]'); }
  get OAS_SD_PORT_IS_SEPARATE_BOX() { this.page.locator('//input[@name="showPortPath"]'); }
  ...
  get OAS_SD_VALUES_ARE_NESTED_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.upstream.serviceDiscovery.useNestedQuery"]'); }
  ...
  get OAS_SD_QUERY_ENDPOINT_SAVED() { this.page.locator('//span[text()="Query Endpoint"]//following::div[2]'); }
  get OAS_SD_TARGET_PATH_SAVED() { this.page.locator('//span[text()="Target Path"]//following::div[2]'); }
  get OAS_SD_CACHE_TIMEOUT_SAVED() { this.page.locator('(//span[text()="Cache Timeout"]//following::div[2])[1]'); }
  get OAS_SD_PORT_DATA_PATH_SAVED() { this.page.locator('//span[text()="Port Data Path"]//following::div[2]'); }
  get OAS_SD_PARENT_DATA_PATH_SAVED() { this.page.locator('//span[text()="Parent Data Path"]//following::div[2]'); }
  get OAS_SD_DATA_PATH_SAVED() { this.page.locator('//span[text()="Data Path"]//following::div[2]'); }
  ...
  get OAS_AUTH_TOKEN_USE_HEADER_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.securitySchemes.token.header.enabled"]'); }
  get OAS_AUTH_TOKEN_USE_QUERY_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.securitySchemes.token.query.enabled"]'); }
  get OAS_AUTH_TOKEN_USE_COOKIE_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.securitySchemes.token.cookie.enabled"]'); }
  ...
  get OAS_AUTH_TOKEN_CONFIG_NAME_SAVED() { this.page.locator('//div[@name="x-tyk-api-gateway.server.authentication.securitySchemes.token.name"]//div[@class="tyk-form-control--readonly"]'); }
  get OAS_AUTH_TOKEN_HEADER_NAME_SAVED() { this.page.locator('//label[text()="Auth Key Header Name"]//following::div[1]'); }
  get OAS_AUTH_TOKEN_QUERY_NAME_SAVED() { this.page.locator('//label[text()="Query parameter Name"]//following::div[1]'); }
  get OAS_AUTH_TOKEN_COOKIE_NAME_SAVED() { this.page.locator('//label[text()="Cookie Name"]//following::div[1]'); }
  ...
  get OAS_BASICAUTH_ENABLE_CHACHING_BOX() { this.page.locator('//label[contains(text(),"Enable Caching")]//input'); }
  ...
  get OAS_BASICAUTH_EXTRACT_CREDENTIALS_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.securitySchemes.basic.extractCredentialsFromBody.enabled"]'); }
  ...
  get OAS_BASICAUTH_USE_HEADER_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.securitySchemes.basic.header.enabled"]'); }
  ...
  get OAS_BASICAUTH_STRIP_AUTHDATA_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.stripAuthorizationData"]'); }
  get OAS_BASICAUTH_ALLOW_QUERY_PARAM_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.securitySchemes.basic.query.enabled"]'); }
  get OAS_BASICAUTH_USE_COOKIE_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.securitySchemes.basic.cookie.enabled"]'); }
  ...
  get OAS_BASICAUTH_CACHE_TTL_SAVED() { this.page.locator('//span[text()="Cache TTL"]//following::div[2]'); }
  get OAS_BASICAUTH_CONFIG_NAME_SAVED() { this.page.locator('//div[@name="x-tyk-api-gateway.server.authentication.securitySchemes.basic.name"]//div[@class="tyk-form-control--readonly"]'); }
  get OAS_BASICAUTH_REGEXP_USERNAME_SAVED() { this.page.locator('//span[text()="Regexp to Extract Username"]//following::div[2]'); }
  get OAS_BASICAUTH_REGEXP_PASSWORD_SAVED() { this.page.locator('//span[text()="Regexp to Extract Password"]//following::div[2]'); }
  get OAS_BASICAUTH_AUTH_HEADER_SAVED() { this.page.locator('//label[text()="Auth Key Header Name"]//following::div[1]'); }
  get OAS_BASICAUTH_QUERY_PARAM_SAVED() { this.page.locator('//label[text()="Query parameter Name"]//following::div[1]'); }
  get OAS_BASICAUTH_COOKIE_VALUE_SAVED() { this.page.locator('//label[text()="Cookie Name"]//following::div[1]'); }
  ...
  get OAS_HMAC_ENABLE_CLOCK_SKEW_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.hmac.enableClockSkew"]'); }
  ...
  get OAS_HMAC_USE_AUTH_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.hmac.header.enabled"]'); }
  ...
  get OAS_HMAC_ALLOW_QUERY_PARAM_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.hmac.query.enabled"]'); }
  get OAS_HMAC_USE_COOKIE_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.hmac.cookie.enabled"]'); }
  ...
  get OAS_OAUTH_AUTHORIZATION_CODE_BOX() { this.page.locator('//input[@name="authorization_code"]'); }
  ...
  get OAS_OAUTH_CLIENT_CREDENTIALS_BOX() { this.page.locator('//input[@name="client_credentials"]'); }
  get OAS_OAUTH_PASSWORD_BOX() { this.page.locator('//input[@name="password"]'); }
  get OAS_OAUTH_REFRESH_TOKEN_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.securitySchemes.oauth.refreshToken"]'); }
  ...
  get OAS_OAUTH_USE_HEADER_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.securitySchemes.oauth.header.enabled"]'); }
  ...
  get OAS_OAUTH_ALLOW_QUERY_PARAM_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.securitySchemes.oauth.query.enabled"]'); }
  get OAS_OAUTH_USE_COOKIE_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.securitySchemes.oauth.cookie.enabled"]'); }
  ...
  //OpenID Connect
  get OAS_OIDC_ENABLE_RL_PER_CLIENT_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.oidc.segregateByClientId"]'); }
  ...
  get OAS_OIDC_ENABLE_SCOPE_CLAIMS_BOX() { this.page.locator('//input[@name="enableScopeClaim"]'); }
  ...
  get OAS_OIDC_USE_HEADER_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.oidc.header.enabled"]'); }
  ...
  get OAS_OIDC_ALLOW_QUERY_PARAM_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.oidc.query.enabled"]'); }
  get OAS_OIDC_USE_COOKIE_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.oidc.cookie.enabled"]'); }
  ...
  //CUSTOM AUTH PLUGIN
  get OAS_CUSTOM_AUTH_USEHEADER_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.custom.header.enabled"]'); }
  ...
  get OAS_CUSTOM_ALLOW_QUERY_PARAM_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.custom.query.enabled"]'); }
  get OAS_CUSTOM_USE_COOKIE_BOX() { this.page.locator('//input[@name="x-tyk-api-gateway.server.authentication.custom.cookie.enabled"]'); }
  ...
  //MODALS
  get MODAL() { this.page.locator('.tyk-modal__content'); }
  ...
  //API MESSAGE POPUPS
  get API_UPDATED_MESSAGE() { this.page.locator('//div[contains(@class, "alert-success")]//span[text()="The Api has been successfully updated"]'); }
  get API_DELETED_MESSAGE() { this.page.locator('//div[contains(@class, "alert-success")]//span[text()="The Api has been successfully deleted"]'); }
