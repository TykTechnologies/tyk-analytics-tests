...
//API Details tab
get API_DETAILS_TAB() { return new Button_object('button*=API details', this.page);}
...
get SETTINGS_TAB_BUTTON() {return new Button_object('button*=Settings', this.page);}
...
get ADD_BUTTON() {return new Button_object('span*=ADD', this.page);}
