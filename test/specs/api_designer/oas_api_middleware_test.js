...
describe('Test Middleware on OAS Endpoints designer page', () => {
  ...
  it('User can add Ignore middelware and save API', () => {
    ...
    apis_page.API_NAME_INPUT.setValue('middleware-test');
  ...
  it('Ignore middelware is disabled after page reload', () => {
    browser.refresh();
    endpoints_page.OAS_ENDPOINTS_BUTTON.click();
    expect(endpoints_page.verifyMiddlewareDisabledByName("Ignore Authentication")).to.be.true;
  });

  it('User can enable Ignore middelware and save API', () => {
    browser.refresh();
    endpoints_page.OAS_ENDPOINTS_BUTTON.click();
    apis_page.EDIT_BUTTON.click();
    endpoints_page.changeMiddlewareStatusByName("Ignore Authentication");
  ...
  it('Ignore middelware is enabled after page reload', () => {
    browser.refresh();
    endpoints_page.OAS_ENDPOINTS_BUTTON.click();
    expect(endpoints_page.verifyMiddlewareDisabledByName("Ignore Authentication")).to.be.false;
  });

  it('User can remove Ignore middelware and save API', () => {
    browser.refresh();
    endpoints_page.OAS_ENDPOINTS_BUTTON.click();
    apis_page.EDIT_BUTTON.click();
  ...
  it('Ignore middelware is removed after page reload', () => {
    browser.refresh();
    endpoints_page.OAS_ENDPOINTS_BUTTON.click();
