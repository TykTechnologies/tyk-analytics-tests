...
describe('Portal Settings main Admin page', () => {
  ...
  it('User should be able to edit all fields and save changes without error', () => {    
    admin_settings_page.ACCESS_REQUEST_INPUT.setValue(email);
    admin_settings_page.DEVELOPER_SIGN_UP_TOGGLE.click();
    admin_settings_page.DEVELOPER_LOGIN_TOGGLE.click();
    admin_settings_page.RESTRICTED_CATALOGUE_TOGGLE.click();
